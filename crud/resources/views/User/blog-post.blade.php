            ...
            <div class="row">
                ...
                <div id="main" class="col-md-9">
                    ...
                    <div class="blog-post-share">
                        ...
                        <span style="font-size: 16px; margin-right: 10px;">
                            <i class="fa fa-thumbs-up like-button" data-liked="1" style="cursor: pointer;"></i>
                            <span class="like-count">{{ $post->likes_count }}</span>
                        </span>
                        <span style="font-size: 16px; margin-right: 10px;">
                            <i class="fa fa-thumbs-down like-button" data-liked="0" style="cursor: pointer;"></i>
                            ...
                            $('.like-button').on('click', function(event) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        // Update the like and dislike counts directly in the DOM
                                        if (liked) {
                                            // If liked, increment the like count
                                            let likeCountElement = $('.like-count');
                                            likeCountElement.text(parseInt(likeCountElement.text()) + 1);
                                        } else {
                                            // If disliked, increment the dislike count
                                            let dislikeCountElement = $('.dislike-count');
                    ...
                    <div class="blog-comments">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p>Cu his iudico appareat ullamcorper, at mea ignota nostrum. Nonumy argumentum id cum,
                                    eos adversarium contentiones id</p>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading">John Doe</h4>
                                    <p>Cu his iudico appareat ullamcorper, at mea ignota nostrum. Nonumy argumentum id
                                        cum, eos adversarium contentiones id</p>
                                    <div class="date-reply"><span>Oct 18, 2017 - 4:00AM</span><a href="#"
                                            class="reply">Reply</a></div>
                                </div>
                            </div>
